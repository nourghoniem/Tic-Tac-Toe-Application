               ...
               try{
                   ...
                   while(true){
                       ...
                       Platform.runLater(()->{
                            ...
                            taLog.appendText("player i's IP address" + player1.getInetAddress().getHostAddress() +'\n');
                       });
                    ...
                    Platform.runLater(()->{
                            ...
                            taLog.appendText("player i's IP address" + player2.getInetAddress().getHostAddress() +'\n');
                       });

                    new DataOutputStream(player2.getOutputStream()).writeInt(PLAYER2);

                    Platform.runLater(()->
                            taLog.appendText(new Date() + "Start a Thread for the session" +sessionNo++ +'\n'));
